...
class SpatialHubPanel extends HTMLElement {
   ...
   *
   *  Der Versatz ist der ANFANG der Namenssuche, nicht ihr Ergebnis:
   *  `roomLabelSpot` sucht von der verschobenen Stelle aus den freien
   *  Boden, sonst schuebe der Versatz den Namen hinterher auf das
   *  Mauerwerk zurueck. Dieselbe Auskunft fuer das Zeichnen und fuer
   *  das Entzerren -- zwei Rechnungen waeren zwei Stellen, an denen
   *  der Name woanders steht, als das Entzerren ihn vermutet.
   */
