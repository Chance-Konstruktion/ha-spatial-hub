...
| b76ffcac | panel | `a door is a doorway with a leaf, a window stays in the wall` |
...
| f3e06640 | panel | `a staircase gets steps, a room called something else does not` |
...
| 80deb5c7 | panel | `a measure that does not fit between its ticks is left out, the ticks stay` |
| be9c6d55 | panel | `the dimension chain splits at the walls and measures in this storey's metres` |
...
| c4578b62 | panel | `a split face draws its own edges and never the cut` |
